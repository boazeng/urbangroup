...
- status: סטטוס תעודה (רלוונטי רק ל-uncharged_delivery). הערכים האפשריים: "טיוטא" או "סופית". דוגמאות: "תעודות בסטטוס טיוטא", "רק טיוטות", "תעודות סופיות", "תעודות שהם טיוטא"
